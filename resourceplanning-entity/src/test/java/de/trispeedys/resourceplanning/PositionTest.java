...
public class PositionTest
{
    ...
    public void testPositionAssignment()
    {
        ...
        //assign positions
        EntityFactory.buildEventCommitment(helper, evt2013, posA, EventCommitmentState.CONFIRMED);
        EntityFactory.buildEventCommitment(helper, evt2014, posC, EventCommitmentState.CONFIRMED);
        //...
