...
public class ProposePositionsDelegate implements JavaDelegate
{
    ...
    public void execute(DelegateExecution execution) throws Exception
    {
        ...
        EntityFactory.buildMessageQueue("noreply@tri-speedys.de", helper.getEmail(),
                "Positions-Auswahl für den Wettkampf " + event.getDescription(), generateProposalBody(helper, event, unassignedPositions), MessagingType.PROPOSE_POSITIONS).persist();
    }
